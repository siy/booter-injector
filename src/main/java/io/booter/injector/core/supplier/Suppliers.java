...
public final class Suppliers {
    ...
    public static <T> Supplier<T> methodSupplier(Method method, Supplier<?>[] parameters) {
        ...
        return () -> safeCall(buildMethodSupplier(method, Arrays.asList(parameters)), method);
    }
    ...
    private static <T> ThrowingSupplier<T> buildMethodSupplier(Method method,
        ...
        switch (method.getParameterCount()) {
            ...
            case  3: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get());

            case  4: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get());

            case  5: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get());

            case  6: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get());

            case  7: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get(), suppliers.get(7).get());

            case  8: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get(), suppliers.get(7).get(), suppliers.get(8).get());

            case  9: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                     suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                     suppliers.get(6).get(), suppliers.get(7).get(), suppliers.get(8).get(),
                                                     suppliers.get(9).get());
            case 10: return () -> (T) method.invoke(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                     suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                     suppliers.get(6).get(), suppliers.get(7).get(), suppliers.get(8).get(),
                                                     suppliers.get(9).get(), suppliers.get(10).get());
            default:
    ...
    public static <T> Supplier<T> constructorSupplier(Constructor<T> constructor, Supplier<?>[] parameters) {
        ...
        return () -> safeCall(buildConstructorSupplier(constructor, Arrays.asList(parameters)), constructor);
    }
    ...
    private static <T> ThrowingSupplier<T> buildConstructorSupplier(Constructor<T> constructor,
        ...
        switch (constructor.getParameterCount()) {
            ...
            case  4: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get());

            case  5: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get());

            case  6: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get());

            case  7: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get());

            case  8: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get(), suppliers.get(7).get());

            case  9: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get(), suppliers.get(7).get(), suppliers.get(8).get());

            case 10: return () -> constructor.newInstance(suppliers.get(0).get(), suppliers.get(1).get(), suppliers.get(2).get(),
                                                          suppliers.get(3).get(), suppliers.get(4).get(), suppliers.get(5).get(),
                                                          suppliers.get(6).get(), suppliers.get(7).get(), suppliers.get(8).get(),
                                                          suppliers.get(9).get());
            default:
