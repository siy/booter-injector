...
public final class AnnotationFactory {
    ...
    public static <A extends Annotation> A create(Class<A> annotation, Map<String, ?> sourceValues) {
        var values = (Map<String, Object>) (sourceValues == null ? Map.of() : sourceValues);
