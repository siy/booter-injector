...
import org.pragmatica.di.Binding;
import org.pragmatica.di.Injector;
import org.pragmatica.di.Key;
import org.pragmatica.di.Module;
import org.pragmatica.di.annotations.ConfiguredBy;
import org.pragmatica.di.annotations.Supplies;
import org.pragmatica.di.core.exception.InjectorException;
import org.pragmatica.di.core.supplier.LambdaFactory;
import org.pragmatica.di.core.supplier.Utils;

import static org.pragmatica.di.core.supplier.SupplierFactory.*;
import static org.pragmatica.di.core.supplier.Suppliers.factoryLazy;
...
public class InjectorImpl implements Injector {
    ...
    private void bindImplementations(Binding<?> binding) {
        ...
        Supplier<?> supplier = binding.resolved() ? (Supplier<?>) binding.binding()
    ...
    private Supplier<?> buildSupplier(Binding<?> binding, Node node) {
        ...
        return binding.singleton()
               ? createSingletonSupplier(node.constructor(), parameters, binding.eager())
