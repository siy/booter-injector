...
public abstract class AbstractModule implements Module {
    ...
    public class Builder<T> {
        ...
        public void to(Class<? extends T> implementation) {
            bindings.add(Binding.toNonSingletonClass(key, implementation));
        }
        ...
        public void toInstance(T instance) {
            bindings.add(Binding.toInstance(key, instance));
        }
        ...
        public void toSupplier(Supplier<? extends T> supplier) {
            bindings.add(Binding.toProvider(key, supplier));
        }
        ...
        public void toLazySingleton(Class<? extends T> implementation) {
            bindings.add(Binding.toLazySingletonClass(key, implementation));
        }
        ...
        public void toEagerSingleton(Class<? extends T> implementation) {
            bindings.add(Binding.toEagerSingletonClass(key, implementation));
        }
