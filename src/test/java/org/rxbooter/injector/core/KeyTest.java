...
import org.rxbooter.injector.TypeToken;
import org.rxbooter.injector.annotations.BindingAnnotation;
import org.rxbooter.injector.core.annotation.AnnotationFactory;
import org.rxbooter.injector.core.beans.ClassWithDefaultConstructor;
...
public class KeyTest {
    ...
    public void shouldCreateKeyForSimpleClass() throws Exception {
        ...
        assertThat(key.type().toString()).isEqualTo("class org.rxbooter.injector.core.beans.ClassWithDefaultConstructor");
        assertThat(key.toString()).isEqualTo("{org.rxbooter.injector.core.beans.ClassWithDefaultConstructor}");
    }
    ...
    public void shouldCreateKeyForSimpleClassWithAnnotation() throws Exception {
        ...
        assertThat(key.toString()).isEqualTo("{org.rxbooter.injector.core.beans.ClassWithDefaultConstructor @interface org.rxbooter.injector.core.KeyTest$TestAnnotation}");
    }
    ...
    public void shouldCreateKeyForTypeTokenWithAnnotation() throws Exception {
        ...
        assertThat(key.annotation()).isInstanceOf(TestAnnotation.class);
        assertThat(key.type().toString()).isEqualTo("java.util.List<java.util.function.Supplier<java.lang.String>>");
        assertThat(key.toString()).isEqualTo("{java.util.List<java.util.function.Supplier<java.lang.String>> @interface org.rxbooter.injector.core.KeyTest$TestAnnotation}");
    }
