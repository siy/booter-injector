...
package org.pragmatica.di.core.examples.annotated.impl;

import org.pragmatica.di.annotations.Singleton;
import org.pragmatica.di.core.examples.annotated.Application;
import org.pragmatica.di.core.examples.annotated.ApplicationConfig;
import org.pragmatica.di.core.examples.annotated.Service;
import org.pragmatica.di.core.examples.annotated.ServiceFactory;
...
public class ApplicationImpl implements Application {
    ...
    private List<Service> startServices() {
        ...
        var running = config.services().stream()
                            .map(factory::create)
                            .peek(Service::start)
